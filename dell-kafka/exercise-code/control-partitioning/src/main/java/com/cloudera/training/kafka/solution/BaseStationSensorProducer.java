...
public class BaseStationSensorProducer implements SensorReadingListener {
    ...
    public void receivedVoltageReading(VoltageReading reading) {
        ...
        //   Field 1: Timestamp
        //   Field 2: Voltage
        // The base station ID will now be sent as the key
        ...
        ProducerRecord<String, String> record = new ProducerRecord<>(topic, reading.getBaseStationId(), sensorData);
        producer.send(record);
        System.out.printf("Sent key: %s, value: %s%n", reading.getBaseStationId(), sensorData);
    }
